    ...
    pushUrl += encodeURIComponent(
      `[本体](${
        jsonData.data.pre_download_game.latest.version
          ? jsonData.data.pre_download_game.latest.segments[0].path
          : jsonData.data.game.latest.segments[0].path
      })\\|`
    )
    pushUrl += encodeURIComponent(
      `[中文语音](${
        jsonData.data.pre_download_game.latest.version
          ? escapeCharacters(
              jsonData.data.pre_download_game.latest.voice_packs[0].path
            )
          : escapeCharacters(jsonData.data.game.latest.voice_packs[0].path)
      })\\|`
    )
    pushUrl += encodeURIComponent(
      `[日文语音](${
        jsonData.data.pre_download_game.latest.version
          ? escapeCharacters(
              jsonData.data.pre_download_game.latest.voice_packs[2].path
            )
          : escapeCharacters(jsonData.data.game.latest.voice_packs[2].path)
      })\\|`
    )
    pushUrl += encodeURIComponent(
      `[英文语音](${
        jsonData.data.pre_download_game.latest.version
          ? escapeCharacters(
              jsonData.data.pre_download_game.latest.voice_packs[1].path
            )
          : escapeCharacters(jsonData.data.game.latest.voice_packs[1].path)
      })\\|`
    )
    pushUrl += encodeURIComponent(
      `[韩文语音](${
        jsonData.data.pre_download_game.latest.version
          ? escapeCharacters(
              jsonData.data.pre_download_game.latest.voice_packs[3].path
            )
          : escapeCharacters(jsonData.data.game.latest.voice_packs[3].path)
      })`
    )
    pushUrl += encodeURIComponent(
      `\n\n本体为分卷, 共有 ${
